...
function DeficiencyModal({ open, onClose, items, vi }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-slate-900 border border-transparent dark:border-slate-800 rounded-3xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div
          className="flex items-center justify-between px-6 py-5 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-br from-red-50/50 to-white dark:from-red-950/20 dark:to-slate-900"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black text-cyan-900 dark:text-cyan-100 font-headline text-lg">
        ...
        <div className="overflow-y-auto flex-1 p-6 space-y-4">
          {items.length === 0 ? (
            ...
            items.map((item, i) => (
              <div
                key={i}
                className="rounded-2xl border border-red-100 dark:border-red-950/30 bg-red-50/60 dark:bg-red-950/10 p-4 flex gap-4"
              >
                {/* Avatar */}
                <div className="w-11 h-11 rounded-full bg-error shrink-0 flex items-center justify-center font-black text-white font-headline text-base">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    <span className="text-[11px] bg-cyan-50 dark:bg-cyan-950/40 text-cyan-700 dark:text-cyan-300 px-2 py-0.5 rounded-full font-semibold border border-cyan-100 dark:border-cyan-900/40">
                      GV: {item.teacherName}
                    </span>
                  </div>

                  {/* Nội dung thiếu sót */}
                  <div className="bg-red-100/70 dark:bg-red-950/30 border border-red-200 dark:border-red-900/30 rounded-xl px-3 py-2 mt-1">
      ...
      <section>
        <div className="flex justify-between items-end mb-6">
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-cyan-900 dark:text-cyan-100 font-headline tracking-tight">
              {t("dash_vitality")}
            </h2>
          </div>
          <div className="text-right">
            <span className="text-sm font-medium text-on-surface-variant dark:text-slate-300 bg-surface-container dark:bg-slate-800 px-3 py-1 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* Tổng Học Sinh */}
          <div className="bg-surface-container-lowest dark:bg-slate-900 border border-transparent dark:border-slate-800/50 p-6 rounded-3xl group hover:bg-cyan-50 dark:hover:bg-cyan-950/10 transition-colors duration-300">
            <div className="flex justify-between items-start mb-4">
              <div className="w-12 h-12 rounded-2xl bg-cyan-100 dark:bg-cyan-950/50 text-cyan-700 dark:text-cyan-400 flex items-center justify-center">
            ...
            <p className="text-4xl font-black text-cyan-900 dark:text-cyan-100 font-headline">
              {stats.students}
            </p>
          </div>
          ...
          <div className="bg-surface-container-lowest dark:bg-slate-900 border border-transparent dark:border-slate-800/50 p-6 rounded-3xl group hover:bg-cyan-50 dark:hover:bg-cyan-950/10 transition-colors duration-300">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-slate-400 dark:text-slate-500 text-xs font-bold bg-surface-container dark:bg-slate-800 px-2 py-0.5 rounded-full">
                {t("dash_stable")}
              </span>
            </div>
            <p className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest mb-1">
          ...
          <div className="bg-surface-container-lowest dark:bg-slate-900 border border-transparent dark:border-slate-800/50 p-6 rounded-3xl group hover:bg-cyan-50 dark:hover:bg-cyan-950/10 transition-colors duration-300">
            <div className="flex justify-between items-start mb-4">
              <div className="w-12 h-12 rounded-2xl bg-tertiary-fixed dark:bg-amber-950/40 text-tertiary dark:text-amber-400 flex items-center justify-center">
                <span className="material-symbols-outlined material-symbols-filled">
                  star
                </span>
              </div>
            ...
            <p className="text-4xl font-black text-cyan-900 dark:text-cyan-100 font-headline">
              ...
              {stats.rating > 0 && (
                <span className="text-xl text-slate-300 dark:text-slate-600">/5</span>
              )}
            </p>
          </div>
          ...
          <div
            className="bg-surface-container-lowest dark:bg-slate-900 border border-error-container/0 dark:border-slate-800/50 p-6 rounded-3xl group hover:bg-error-container/20 dark:hover:bg-red-950/10 transition-all duration-300 cursor-pointer hover:shadow-md hover:scale-[1.02]"
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div className="w-12 h-12 rounded-2xl bg-error-container dark:bg-red-950/50 text-error dark:text-red-400 flex items-center justify-center">
                <span className="material-symbols-outlined material-symbols-filled">
                  warning
                </span>
              </div>
            ...
            <p className="text-4xl font-black text-error dark:text-red-500 font-headline">
              {stats.deficiencies}
            </p>
