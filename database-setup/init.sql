...
-- ============================================================
-- SEED DATA — Tài khoản quản trị Admin duy nhất
-- Mật khẩu đăng nhập: admin (bcrypt rounds=10)
-- ============================================================
INSERT INTO `users` (`email`, `password_hash`, `role`) VALUES
('admin@school.com', '$2b$10$LpBFyFPwl9DI.AafYhcNsOwELtWQw4oPeYjcfYgLHn06.ZchyNK6O', 'ADMIN');
